...
describe Fabrication::Syntax::Make do
  describe '#make mongoid', depends_on: :mongoid do
    it 'returns a fabricated object' do
    ...
    it 'treats a first non-hash argument as fabrication name suffix' do
    ...
    it 'works the same as Fabricate.build' do
  ...
  describe '#make sequel', depends_on: :sequel do
    ...
    it 'is the same as Fabricate.build' do
